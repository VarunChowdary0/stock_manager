...
import { url } from '../controllers/Server_URL';
...
const HomePage:React.FC = () => {
    ...
    const [timeout,setTimeout_] = useState<boolean>(false);
  ...
  return (
    ...
    <>
        ...
        (
            timeout ? 
            <div className=' h-screen w-full flex font-thin items-center justify-center
            text-5xl text-white flex-col gap-10'>
                <p>Please Contact Developer, Server offline</p>
                <span>⚠️</span>
            </div>
            :
